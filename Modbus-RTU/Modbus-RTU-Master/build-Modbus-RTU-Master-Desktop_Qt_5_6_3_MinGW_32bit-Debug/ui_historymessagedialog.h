...
public:
    ...
    QTextBrowser *HistoryMessageBox;
    ...
    void setupUi(QDialog *HistoryMessageDialog)
    {
        ...
        HistoryMessageBox = new QTextBrowser(HistoryMessageDialog);
        HistoryMessageBox->setObjectName(QStringLiteral("HistoryMessageBox"));
        QSizePolicy sizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(HistoryMessageBox->sizePolicy().hasHeightForWidth());
        HistoryMessageBox->setSizePolicy(sizePolicy);
        HistoryMessageBox->setMinimumSize(QSize(0, 0));
    ...
    void retranslateUi(QDialog *HistoryMessageDialog)
    {
        ...
        HistoryMessageBox->setDocumentTitle(QApplication::translate("HistoryMessageDialog", "\345\216\206\345\217\262\346\266\210\346\201\257", Q_NULLPTR));
    } // retranslateUi
